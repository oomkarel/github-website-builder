...
function TextBlock({
  ...
  return <section className="py-6 md:py-8 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-left prose-h1:md:text-3xl prose-h1:mb-4 prose-h1:mt-0 /* In CMS content, body text is sometimes authored as H2/H3. Style them like description/subtitle (not big headings). */ prose-h2:md:text-lg prose-h2:leading-relaxed prose-h2:mb-4 prose-h2:mt-0 prose-h3:md:text-lg prose-h3:leading-relaxed prose-h3:mb-4 prose-h3:mt-0 prose-p:md:text-lg prose-p:leading-relaxed prose-p:mb-4 prose-a:no-underline hover:prose-a:underline prose-ul:my-4 prose-li:leading-relaxed prose-blockquote:border-l-primary prose-blockquote:bg-muted/30 prose-blockquote:py-2 prose-blockquote:rounded-r-lg font-normal font-sans text-accent-foreground text-lg" dangerouslySetInnerHTML={{
