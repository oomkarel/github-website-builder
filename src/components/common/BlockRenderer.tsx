      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div 
          className="prose prose-lg dark:prose-invert max-w-none text-left
            ...
            /* In CMS content, body text is sometimes authored as H2/H3. Style them like description/subtitle (not big headings). */
            prose-h2:text-base prose-h2:md:text-lg prose-h2:font-normal prose-h2:text-muted-foreground prose-h2:leading-relaxed prose-h2:mb-4 prose-h2:mt-0
            prose-h3:text-base prose-h3:md:text-lg prose-h3:font-normal prose-h3:text-muted-foreground prose-h3:leading-relaxed prose-h3:mb-4 prose-h3:mt-0
            prose-p:text-muted-foreground prose-p:text-base prose-p:md:text-lg prose-p:leading-relaxed prose-p:mb-4
